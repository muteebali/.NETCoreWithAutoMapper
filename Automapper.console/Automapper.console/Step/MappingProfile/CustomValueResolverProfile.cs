...
namespace Automapper.console.Step.MappingProfile
{
    ...
    public class CustomResolver : IValueResolver<CustomValueResolver_Source, CustomValueResolver_Destination, int>
    {
        public int Resolve(CustomValueResolver_Source source, CustomValueResolver_Destination destination, int destMember, ResolutionContext context)
        {
            return source.ItemPrice - source.Discount;
